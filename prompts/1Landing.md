Use the ShadCN MCP server to bring in necessary components to build a SaaS landing page for an Ai-Driven website called Fennec Will Builder
...
The headline should say "Fennec Will Builder" with a CTA button to "Sign Up".

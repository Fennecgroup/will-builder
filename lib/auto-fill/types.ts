...
export const ARTICLE_TITLES: Record<WillArticle, string> = {
  ...
  USUFRUCT_BEQUESTS: 'ARTICLE VII - USUFRUCT BEQUESTS',
  SPECIFIC_BEQUESTS: 'ARTICLE VIII - SPECIFIC BEQUESTS',
  RESIDUARY_ESTATE: 'ARTICLE IX - RESIDUARY ESTATE',
  INHERITANCE_EXCLUSIONS: 'ARTICLE X - INHERITANCE EXCLUSIONS',
